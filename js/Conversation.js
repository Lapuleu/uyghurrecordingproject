...
document.addEventListener('DOMContentLoaded', function() {
    ...
    let conversationFooter = '<div class="container" id="footer-text"> <div class="row"> <section id="contact" class="text-center"> <span id="contact-span">Contact: </span> <br id="email"> Email - <a class="footerLink" href="mfiddler@ucsb.edu">mfiddler@ucsb.edu</a> <br id="web"> Web design - Haibibullah Abdul-Kerim, Saibilila Abdul-Kerim <p id="footer-description">*Project organized by Michael Fiddler, in collaboration with the <a class="footerLink" href="https://uyghursfoundation.org/en/">Uyghur Projects Foundation</a></p> <hr class="visible-xs text-center"> </section> </div> <div class="text-center" style="width: 70%; margin: auto; margin-top: -50px; color: white;">Corpus of Conversational Uyghur © 2023 by Michael Fiddler is licensed under<a href="https://creativecommons.org/licenses/by-nc/4.0/" style="color: white;">CC BY-NC 4.0</a><img src="https://mirrors.creativecommons.org/presskit/icons/cc.svg" style="max-width: 1em;max-height:1em;margin-left: .2em;"><img src="https://mirrors.creativecommons.org/presskit/icons/by.svg" style="max-width: 1em;max-height:1em;margin-left: .2em;"><img src="https://mirrors.creativecommons.org/presskit/icons/nc.svg" style="max-width: 1em;max-height:1em;margin-left: .2em;"> </div> </div>';
